...
class DecodeCommand():
    ...
    def prepare_parser(self, parser: argparse.ArgumentParser):
        ...
        parser.add_argument("--parallel", dest='parallel', action='store_true', help="Run in parallel")
        parser.add_argument("--lemmatize", dest='lemmatize', action='store_true', help="Lemmatize the feature norm")
